...
const scanningSteps = [
  { text: "Uploading your bill...", icon: "upload" },
  { text: "Extracting text from image...", icon: "scan" },
  { text: "Analyzing line items...", icon: "analyze" },
  { text: "Comparing with standard rates...", icon: "compare" },
  { text: "Generating report...", icon: "report" },
]
